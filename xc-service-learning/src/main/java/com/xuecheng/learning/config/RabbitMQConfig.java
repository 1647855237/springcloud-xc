...
public class RabbitMQConfig {
    //添加选课任务交换机
    public static final String EX_LEARNING_CHOOSECOURSE = "ex_learning_addchoosecourse";
     ...
     * @return the exchange
     */
    @Bean(EX_LEARNING_CHOOSECOURSE)
    public Exchange EX_DECLARE() {
        return ExchangeBuilder.directExchange(EX_LEARNING_CHOOSECOURSE).durable(true).build();
    }
     ...
     */
    @Bean
    public Binding binding_add_processtask(@Qualifier("xc_learning_addchoosecourse") Queue queue, @Qualifier(EX_LEARNING_CHOOSECOURSE) Exchange exchange) {
     ...
     */
    @Bean
    public Binding binding_finish_processtask(@Qualifier("xc_learning_finishaddchoosecourse") Queue queue, @Qualifier(EX_LEARNING_CHOOSECOURSE) Exchange exchange) {
